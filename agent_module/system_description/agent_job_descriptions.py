...
4.  **GENERATE PLAN:** Create a detailed, structured plan document using Markdown. This plan should clearly outline:
    * Project structure (folders, files).
    * The navigation structure (e.g., Stack, Tab, Drawer).
